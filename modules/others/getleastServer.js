...
module.exports = client => {
    ...
    const nodestatChannelID = "948222855366189076";
    ...
    async function getLeast() {
        ...
        client.channels.fetch(nodestatChannelID).then(channel => {
            channel.messages.fetch(nodestatMessageID).then(msg => {
                    ...
                    const online = "<a:online:937156921507598436>";
                    const offline = "<a:offline:937156921461469214>";
                    const embed = new Discord.MessageEmbed()
                        .setColor(client.config.color)
                        .setAuthor("KooJe | Nodestats", msg.guild.iconURL({ dynamic: true }), "https://status.kooje.me/")
