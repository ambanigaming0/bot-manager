...
function theDB(client, guild) {
    ...
    *Someone will help you soon*`,
    ...
    client.setups.set(guild.id, {
        enabled: true,
        guildid: guild.id,
        parentid: "938466109923942442",
        message: `Hey {user}! Thanks for opening a TICKET buying a <a:Valid_Code_Developer:858405056238714930> **SOURCE CODE**
    \`\`\`diff
    ...
    client.setups.set(guild.id, {
        enabled: true,
        guildid: guild.id,
        parentid: "945014350022844496",
        message: `Hey {user}! Thanks for opening a TICKET buying a <:earlydev:943838212789534720> **CUSTOM BOT**
    \`\`\`diff
    - Please tell us what features the Bot should have!
    \`\`\`
    <:arrow:936667980237000834> Name, Prefix, Avatar, Colorschema
    <:arrow:936667980237000834> Features, If Music, Lavalink yes/no?
    <:arrow:936667980237000834> When do you need it to be finished?
    <:arrow:936667980237000834> How much are you willing to spend?

    __**Payment Methods:**__
    > [Paypal](https://paypal.me/simonprotyo), PaySafe Card or Sofort


    The <@&936782688495497226> will help you soon! (Or a: <@&935688563805278309>)`,
        adminroles: [Roles.OwnerRoleId, "936782688495497226"],
    }, "ticketsystem8");
    //ADMINISTRATION BOT
    client.setups.set(guild.id, {
        enabled: true,
...
async function logAction(client, type, user, color, thumbnail, message) {
    let logChannelIds = {
        "botmanagement": "941766709348548689"
    };
